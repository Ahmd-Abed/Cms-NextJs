...
const STRAPI_API_URL =
  "http://127.0.0.1:1337/api/Home-page?populate[NavBar][populate]=*&populate[ContentHomePage][populate]=*&populate[carousel_collections][populate]=Image&populate[news_collections][populate]=Image";
